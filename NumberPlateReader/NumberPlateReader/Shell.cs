...
namespace NumberPlateReader
{
    class Shell
    {
        ...
        {
            NumberPlateReader.Shell.ShellFileOperation fo = new NumberPlateReader.Shell.ShellFileOperation();
            String[] s = new String[1];
            String[] d = new String[1];
            s[0] = source;
            d[0] = destination;
            fo.Operation = NumberPlateReader.Shell.ShellFileOperation.FileOperations.FO_COPY;
